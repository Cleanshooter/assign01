...
public class Logic
    ...
    public static double boxSurfaceArea(double mLength, double mWidth, double mHeight) {
        double area = (2 * (mHeight * mWidth)) + 2 * (mHeight * mLength) + 2 * (mWidth * mLength);
        return area;
    }
    ...
    public static double rightTrianglePerimeter(double l, double w) {
        return l + w + Math.sqrt(l * l + w * w);
    }

    public static double rightTriangleArea(double l, double w) {
        return (l * w) / 2;
    }
